...
The Pi command uses the current watcher-extension carrier. The 2026-07-09 validation predated the watcher-only lifecycle change and is historical evidence only; it is not current wiring.
