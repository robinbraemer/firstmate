...
Primary-session turn-end guard integrations for verified non-Pi harnesses are tracked as repo-level hook files and documented in [`docs/turnend-guard.md`](turnend-guard.md).
