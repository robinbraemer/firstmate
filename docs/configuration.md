...
Primary-session turn-end guard integrations are tracked as repo-level hook files or within the Pi watcher extension and documented in [`docs/turnend-guard.md`](turnend-guard.md).
